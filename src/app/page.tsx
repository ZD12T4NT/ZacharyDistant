    ...
    <section className="relative no-scroll flex flex-col p-[2rem] translate-y-1/3 md:translate-y-[20%]">
      ...
      >
        ...
        <motion.h1 className="relative z-50" variants={textRevealMotion(0)}>
          ...
          {/* Image Arrow Icon */}
          {/* <div className="w-[6rem]"><img className="h-full w-full object-contain" src="/arrow-right-white.svg"/></div> */}
        ...
        <div className="relative z-50">
          <motion.h1 className="z-20 flex md:justify-end w-full" variants={textRevealMotion(0.2)}>
            <span className="flex">Into <span className="italic md:not-italic text-[#4c6bc3] md:text-white ml-3">Exceptional</span></span>
          </motion.h1>
        </div>

        <motion.h1 className="leading-none z-20 flex align-middle justify-end md:justify-start md:flex-row-reverse w-full" variants={textRevealMotion(0.2)}>
          Websites
        </motion.h1>

        <div className=" z-30 flex flex-wrap md:flex-nowrap mt-[3rem] md:mt-[5rem]">
          <motion.div className="w-3/4" initial={{ opacity: 0 }}
            animate={{
              opacity: 1,
              transition: {
                delay: 1,
            ...
            <div className="sub-heading w-full flex align-top">
              <span className="text-white/10 text-[1.3rem] leading-none">my purpose</span>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }}
            ...
            <div className="desc w-full md:w-[60%] mt-[1.3rem] md:mt-0 m-auto mb-5">
              <p className="font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, amet sint. Sapiente alias eius quam?</p>
