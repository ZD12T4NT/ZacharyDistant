        ...
        <div className="project-title p-[2em] lg:p-0 ">
          <div>
            <div className="page-head flex align-baseline">
              <div className="page-title w-full r m-0 text-ellipsis overflow-x-hidden text-[2rem] sm:text-[3.24rem] md:text-[5rem] text-left md:text-center font-[var(--main)] text-[#0075ad]">
                Sigmar Recruitment
              </div>
            </div>
