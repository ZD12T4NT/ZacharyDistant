        ...
        <div className="project-title p-[2em] lg:p-0 ">
          <div>
            ...
            <div className="page-title w-full m-0 text-left md:text-center">
                <a href="https://www.sigmarrecruitment.com/" className="text-[2rem] sm:text-[3.24rem] md:text-[5rem]  font-[var(--main)] text-[#007dad] text-ellipsis overflow-x-hidden " target="_blank">
                Sigmar Recruitment
                </a>
              </div>
            </div>
