        ...
        <div className="project-title p-[2em] lg:p-0 ">
          <div>
            ...
            <div className="page-title w-full m-0 text-left md:text-center">
                <a href="https://www.integro.partners/" className="text-[2rem] sm:text-[3.24rem] md:text-[5rem]  font-[var(--main)] text-[#e2001e] text-ellipsis overflow-x-hidden " target="_blank">
                Barrington James
                </a>
              </div>
            </div>
