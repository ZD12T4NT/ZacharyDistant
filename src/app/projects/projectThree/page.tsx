        ...
        <div className="project-title p-[2em] lg:p-0 ">
          <div>
            ...
            <div className="page-title w-full m-0 text-left md:text-center">
                <a href="https://www.roc-search.com/" className="text-[2rem] sm:text-[3.24rem] md:text-[5rem]  font-[var(--main)] text-[#fe671b] text-ellipsis overflow-x-hidden " target="_blank">
                ROC Search
                </a>
              </div>
            </div>
            ...
            <div className="project-data w-full md:w-1/2" >
              <table>
                <tbody>
                  <tr>
                    <td>
                      <h6 className='text-[#fe671b]'>Category</h6></td>
                      <td>
                        <ul>
          ...
          <div className="project-description w-full md:w-1/2 " ><p>roc Recruitment is a leading recruitment agency in Ireland, dedicated to connecting talent with leading businesses. Their website offers a user-friendly interface for job seekers and employers, providing resources such as salary guides and blogs to support informed decision-making.</p>
          </div>
          </div>

          <div className="project-content p-[2em] lg:p-0 text-[1.2rem]" ><h6>Showcase</h6>
          <div className="project-content-wrapper"><img src="/rocimageone.png" alt="" />
          </div>
          <div className="project-content-wrapper"><img src="/rocimagetwo.png" alt="" /></div>
          <div className="project-content-wrapper"><img src="/rocimagethree.png" alt="" /></div>
          <div className="project-content-wrapper"><img src="/rocimagefour.png" alt="" /></div>
          <div className="project-content-wrapper"><img src="/rocimagefive.png" alt="" /></div>
