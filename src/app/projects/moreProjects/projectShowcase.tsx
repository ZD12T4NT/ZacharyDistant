...
const ProjectShowcase: React.FC<ProjectShowcaseProps> = ({ images }) => {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
    >
      <div className="w-[90%] max-h-[80vh] p-2">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {images.map((project, index) => (
            ...
            >
              ...
              <motion.p
                className="mt-2 text-lg font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              >
                {project.name} →
              </motion.p>
            </a>
