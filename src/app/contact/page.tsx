      ...
      <motion.div className="contact flex flex-wrap lg:justify-between">
        <div className="left-side w-full lg:w-[60%] lg:pr-[1rem]">
          <div className="page-head flex align-baseline flex-col">
            <div className="page-title w-full text-left m-0 text-ellipsis overflow-x-hidden text-[2rem] md:text-[3rem] lg:text-[4rem] xl:text-[7rem] leading-none overflow-hidden">LETS <span className='lg:ml-[5rem] lg:block'>GET IN</span> TOUCH</div>
            <motion.hr 
