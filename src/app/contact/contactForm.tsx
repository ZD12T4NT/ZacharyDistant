  ...
  return (
    <form onSubmit={sendEmail} className="contact-form flex flex-col gap-4">
      <div className="form-group flex flex-col">
        ...
        <input className="form-textarea p-[0.8rem] border-b-2 border-b-white resize-y min-h-[50px]" type="text" id="name" name="name" onChange={handleChange} required />
      </div>

      <div className="form-group flex flex-col">
        <label htmlFor="email">Email</label>
        <input className="form-textarea p-[0.8rem] border-b-2 border-b-white resize-y min-h-[50px]" type="email" id="email" name="email" onChange={handleChange} required />
      </div>

      <div className="form-group flex flex-col">
        <label htmlFor="message">Message</label>
        <textarea className="form-textarea p-[0.8rem] border-b-2 border-b-white resize-y min-h-[100px]" id="message" name="message" onChange={handleChange} required />
      </div>
